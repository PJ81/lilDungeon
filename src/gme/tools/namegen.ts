...
export default class NameGen {
  ...
  constructor() {
    ...
    this.mid = "ba,be,chi,dra,du,ga,ghi,go,lia,ma,mba,mu,n'e,na,nti,nzu,phe,pho,r'e,rba,rgo,ssa,thi,tryu,ttu,tzi,v-e,vna,xra,ya,al,an,ar,el,en,ess,ian,onn,or,ad,ag,and,ant,anth,ard,as,at,atr,eg,ent,ern,et,in,itr,on,op,ov,ur,ymn,yr,de,do,duna,hara,kaltho,la,latha,le,nari,ra,re,rego,ro,rodda,romi,rui,sa,to,zila".split(",");
    this.end = "b'ael,bel,bub,bur,bus,ces,chus,dai,ddon,des,dhaka,el,fer,flas,gion,gon,gor,klet,kor,ksha,kuth,laas,lech,les,lion,lith,loch,lsu,mael,math,mejes,meus,mon,moth,mmut,mosh,nai,nar,neus,nex,nias,nnin,nomos,phas,r'el,raal,rept,res,rgon,riax,rith,rius,rous,rus,ruth,sias,stor,swath,tath,than,the,thra,tryus,tura,vart,ztuk,ai,an,ar,ath,en,eo,ian,is,u,or,a,aia,ana,as,ea,ene,eos,esia,ia,iad,ias,ium,ius,on,ona,ova,um,us,ya,bar,bers,blek,chak,chik,dan,dar,das,dig,dil,din,dir,dor,dur,fang,fast,gar,gas,gen,gorn,grim,gund,had,hek,hell,hir,hor,kan,kath,khad,lach,lar,ldil,ldir,leg,len,lin,mas,mnir,ndil,ndur,neg,nik,ntir,rab,rach,rain,rak,ran,rand,rath,rek,rig,rim,rin,rion,sin,sta,stir,sus,tar,thad,thel,tir,von,vor,yon,zor".split(",");
  }

  getName(): string {
    let n = "";
    n = `${this.start[lcg.randNbrI(this.start.length)]}${this.mid[lcg.randNbrI(this.mid.length)]}${this.end[lcg.randNbrI(this.end.length)]}`;
    return n;
  }
}
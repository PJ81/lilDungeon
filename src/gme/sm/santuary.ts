...
export default class Sanctuary extends State {
  ...
  private drawWin(ctx: CanvasRenderingContext2D) {
    ...
    ctx.fillText("CONGRATULATIONS!", m, 80);
    ...
    ctx.fillText(`sacred items back to their sacred places.`, m, l += 20);
    ctx.fillText(`It was certainly not an easy task`, m, l += 20);
    ctx.fillText(`but you mastered it bravely!`, m, l += 20);
    ctx.fillText(`I thank you very much ${this.player.name}.`, m, l += 20);
  ...
  private drawLose(ctx: CanvasRenderingContext2D) {
    ...
    ctx.fillText(`I thought you would bring the sacred items`, m, l += 20);
    ctx.fillText(`back to their sacred places.`, m, l += 20);
    ctx.fillText(`It was certanlly not an easy task, I know,`, m, l += 20);
    ctx.fillText(`but I've expected more from!`, m, l += 20);
    ctx.fillText(`Try again, ${this.player.name}, maybe this time...`, m, l += 20);
